...
def et_param(k):
    ...
    model = et_model(n_estimators[k],criterion[k%2],max_depth[k%4],max_features[k],min_samples_leaf[k])#,class_weight[k]
    return model
...
def main():
    ...
    filename="H:\\ET/model/main_et_B_20170220" # nam prefix
